...
<body>
    ...
    <div class="container">
        <div class="images">
            <img src="static/images/short/2.png">
            <br>
            <h3>Greeny Maternity Short Dress
            </h3>
            <h3>Rs.650</h3>
        </div>
        <br><br>
        <div class="information">
            ...
            <a href="maxi2.php"><img src="static/images/short/1.jpg"></a>
            <a href="maxi3.php"><img src="static/images/short/3.jpg"></a>
          
            <a href="maxi4.php"><img src="static/images/short/4.jpg"></a>
        </div>
            <br><br>
            <div class="size">
            <h4>Sizes</h4><br>
