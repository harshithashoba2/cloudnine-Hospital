...
<body>
    ...
    <div class="container">
        <div class="images">
            <img src="static/images/maxi/3.jpeg">
            <br>
            <h3>Comfortable Maxi Dress</h3>
            <h3>Rs.800</h3>
        </div>
        <br><br>
        <div class="information">
            ...
            <a href="maxi2.php"><img src="static/images/maxi/1.jpeg"></a>
            <a href="maxi3.php"><img src="static/images/maxi/2.jpeg"></a>
        ...
        <div class="description">
            ...
            <p><ul>
                ...
                <li>Length: Maxi</li>
                <li> Pattern: Printed; Neck: Round Neck</p></ul>
        </div>
        </div>
        <br><br>
