...
<body>
    ...
    <div class="container">
        <div class="images">
            <img src="static/images/toys/4.jpg">
            <br>
            <h3>JCB Excavator Truck Automobile Vehicle 4CH
            </h3>
            <h3>Rs.950</h3>
        </div>
        <br><br>
        <div class="information">
            ...
            <a href="maxi4.php"><img src="static/images/toys/1.jpg"></a>
        </div>
            <br><br>
        ...
        <div class="description">
            <h4>Description</h4>
            <p><ul>
                <li>JCB Toy Made of Non toxic Plastic material</li>
                <li>Earth Mover Pull back action, No battery required.</li>
                <li> JCB Excellent body graphixs</li>
                <li>Detailed features</li>
                    <li>JCB Toys tractor Ideal For Girls & Boys</li>
                </ul></p>
        </div>
        </div>
        <br><br>
